<form method="POST" enctype="multipart/form-data" class="bg-white border-2 border-black rounded-lg shadow mx-auto max-w-none px-4 py-5 sm:px-6 space-y-3">
  <!-- Create Post Card Top -->
  <div>
    <div class="flex items-start /space-x-3/">
      <!-- User Avatar -->
      <div class="flex-shrink-0">
        <img class="h-10 w-10 rounded-full object-cover" src="{{ $userAvatar }}" alt="{{ $userName }}" />
      </div>
      <!-- /User Avatar -->
      ...
      <div class="text-gray-700 font-normal w-full">
        <textarea
          ...
          name="barta" rows="2" placeholder="What's going on, {{ $userName }}?"></textarea>
      </div>
    </div>
  </div>
