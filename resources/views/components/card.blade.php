      ...
      <div class="flex items-center justify-between">
          <div class="flex items-center space-x-3">
              ...
              <div class="text-gray-900 flex flex-col min-w-0 flex-1">
                  <a href="{{ $userTwitter }}" class="hover:underline font-semibold line-clamp-1">{{ $userName }}</a>
                  <a href="{{ $userTwitter }}" class="hover:underline text-sm text-gray-500 line-clamp-1">@ {{ basename($userTwitter) }}</a>
              </div>
              <!-- /User Info -->
          </div>
